...
# EP2 - PacMan
# Integrante 1: João Pedro Pardinho Rodrigues
# Integrante 2: Igor Barreto Santos
# Integrante 3: Leticia Estefany Rodrigues Alves
# Integrante 4: Maria Gabriela Figueiredo
######################################################
...
def movimentacao(xPersonagem, yPersonagem, intencao):
    ...
    Parâmetros:
        xPersonagem:      Posição em relação ao eixo X
        yPersonagem:      Posição em relação ao eixo Y
...
def distancia_perseguidor(xPersonagem, yPersonagem, xFantasma, yFantasma):
    ...
    # if distancia_cima < distancia_atual:
    #     return CIMA

    # elif distancia_baixo < distancia_atual:
    #     return BAIXO

    # elif distancia_esquerda < distancia_atual:
    #     return ESQUERDA

    # elif distancia_direita < distancia_atual:
    #     return DIREITA
